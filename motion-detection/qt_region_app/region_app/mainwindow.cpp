...
int MainWindow::testBase()
{
    ...
    std::string basefile = "/jose/repos/IMAGE_DATA.txt";
    std::ofstream file(basefile);
    if (!file)
    {
    ...
    /*int package = 100000;
    int s3 = div_ceil(enc.size(), package);
